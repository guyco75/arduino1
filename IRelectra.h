...
public:
    ...
    bool SendElectra(int power, int mode, int fan, int temperature, int swing, int sleep, bool tempNotif, bool iFeel);

private:
    IRsend* _remote;
    uint64_t EncodeElectra(int power, int mode, int fan, int temperature, int swing, int sleep, bool tempNotif, bool iFeel);
